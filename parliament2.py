...
def parse_arguments():
    ...
    args.add_argument("--threads", required=False, help="The number of threads to use for processing.",dest="threads", type=int, default=0)
