...
def parse_arguments():
    ...
    args.add_argument('--fa_dict', required=False, help="(Optional) The name of the corresponding dict file (generated by Picard) for the reference genome file.")
...
def run_parliament(bam, bai, gatk_jar, ref_genome, fai, fa_dict, prefix, filter_short_contigs, breakdancer, breakseq, manta, cnvnator, lumpy, delly_deletion, delly_insertion, delly_inversion, delly_duplication, genotype, atlas, stats, svviz, svviz_only_validated_candidates):
...
def main():
    ...
    if not args.bam.startswith("/home/dnanexus/in/"):
        ...
        args.fa_dict = "/home/dnanexus/in/{0}".format(args.fa_dict)

    ref_genome_name = gunzip_input(args.ref_genome)

    run_parliament(args.bam, args.bai, args.gatk_jar, ref_genome_name, args.fai, args.fa_dict, prefix, args.filter_short_contigs, args.breakdancer, args.breakseq, args.manta, args.cnvnator, args.lumpy, args.delly_deletion, args.delly_insertion, args.delly_inversion, args.delly_duplication, args.genotype, args.atlas, args.stats, args.svviz, args.svviz_only_validated_candidates)
