...
def main(**job_inputs):
    ...
    docker_pull = ['docker', 'pull', 'dnanexus/parliament2:v0.1.10']
    ...
    docker_call = ['docker', 'run', '-v', '/home/dnanexus/in/:/home/dnanexus/in/', '-v', '/home/dnanexus/out/:/home/dnanexus/out/', 'dnanexus/parliament2:v0.1.10', '--bam', bam_name, '-r', ref_name, '--prefix', str(prefix)]
